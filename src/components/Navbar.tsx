...
/*openCart & cartQuantity from Context/ShoppingCartContext. In addition, we have the shopping cart icon (SVG) -- inside a button -- that opens the shopping cart. You can only see the shopping
cart when it has items in it. It displays the quantity of items in the cart.*/
